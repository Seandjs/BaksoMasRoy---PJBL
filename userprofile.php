      ...
      <div class="edit-profile-card">
        ...
        <form class="profile-form" action="updateprofile.php" method="POST">
          <div class="form-group">
            ...
            <input type="text" name="username" value="<?= $user['username'] ?>" placeholder="Tedjo" />
          </div>

          <div class="form-group">
            <label>Email Address</label>
            <input type="email" name="email" value="<?= $user['email'] ?>" placeholder="Terbaik@gmail.com" />
          </div>
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($o['metode'] === "qris"): ?>
                      <span class="status dine-processing">QRIS</span>
                    <?php else: ?>
                      <span class="status dine-ready">COD</span>
                    <?php endif; ?>
                  </td>

                  <td>
                    <a class="details-btn" href="struk.php?order=<?= $o['id'] ?>">
                      Lihat Detail
                    </a>
                  </td>
                </tr>
